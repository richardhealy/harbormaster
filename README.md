...
- [docs/architecture.md](./docs/architecture.md) — component map, data/control flow through a dispatch, key design decisions and trade-offs, external dependencies, and a spec-to-code map.

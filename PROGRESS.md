...
| # | Milestone | Status |
|---|-----------|--------|
| M0 | Scaffold: control-plane, Postgres schema, GitHub App webhook, port release.sh into release/ | ☑ Done |
...
| # | Deliverable | Status |
|---|-------------|--------|
| D1 | Inline doc comments (TSDoc across public surface) | ☐ Not started |
| D2 | API reference (OpenAPI spec + docs/api.md) | ☐ Not started |
| D3 | Architecture dossier (docs/architecture.md) | ☐ Not started |
| D4 | Integration guide (docs/integration.md) | ☐ Not started |
| D5 | Usage guides + docs/ index + README final pass | ☐ Not started |
